...
@ApiResponses(value = {
		...
		@ApiResponse(code = 403, message = "Sem permissão para acessar recurso!."),
...
public class FuncionarioController {
	...
	@PostMapping("/salvar")
	public String salvar(FuncionarioDTO funcionarioDTO, BindingResult resultado, RedirectAttributes atributo) {
		...
		atributo.addFlashAttribute("sucesso", "Funcionario incerido a lista com sucesso!");
	...
	public String excluir(@PathVariable("id") Long id, RedirectAttributes atributo) {
		servico.excluir(id);
		atributo.addFlashAttribute("sucesso", "Funcionario excluido com suscesso!");
